...
import { addBond } from "../service-api/api";
...
const AddBond= () => 
{
  ...
  return(
    ...
    <Container>
    <Typography variant="h4" color='white' bgcolor='#1976d2' align="center">Add Bond</Typography>
    
<FormControl>
          <InputLabel>Bond_id</InputLabel>
          <Input onChange={(e) => onValueChange(e)} name="BondId" />
      </FormControl>
<FormControl>
...
<FormControl>
      ...
      <FormControl>
          <Button onClick={() => addUserDetails()} variant="contained"><b>Add Bond</b></Button>
      </FormControl>
