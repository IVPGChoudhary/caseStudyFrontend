...
import { getequity,editequity } from "../service-api/api";
...
const EditEquity = () =>{
    ...
    const editEquity = async () => {
       await editequity(bond,id);
       navigate('/');
    }

    return(
        <Container>
        <Typography variant="h4">Add Equity</Typography>
    ...
    <FormControl>
          ...
          <FormControl>
              <Button onClick={() => editEquity()} variant="contained">Add User</Button>
          </FormControl>
